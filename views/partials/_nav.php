          ...
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <div>
              ...
              <?php else: ?>
                  ...
                  <a href="/register" class="<?= urlIs("/register") ?>text-gray-300 text-white hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Register</a>
              <?php endif; ?>
            </div>
          </div>
          ...
          <div class="ml-3">
            <form action="/logout" method="POST">
              <input type="hidden" name="_method" value="DELETE">
                <button class="text-gray-300 text-white hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Log Out</button>
            </form>
          </div>
          <?php endif; ?>
